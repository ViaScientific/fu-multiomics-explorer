...
RUN R -e 'install.packages(c("shiny", "shinyBS", "Seurat", "htmlwidgets", "graph", "jsonlite", "igraph", "tidyverse", "DT", "shinycssloaders", "shinydashboard", "svglite", "shinyjs", "data.table", "BiocManager", "bslib", "bsicons"), \
